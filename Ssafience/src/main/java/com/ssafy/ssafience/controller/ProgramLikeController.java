...
@Api(tags = "ProgramLike : 프로그래밍 게시판 좋아요")
@CrossOrigin("*")
@RestController
@RequestMapping("/api/program")
public class ProgramLikeController {

	private static final Logger logger = LoggerFactory.getLogger(ProgramLikeController.class);
	...
	public ResponseEntity<BasicResponse> likeFreeBoard(@RequestBody LikeRequest request){
		...
		try {
			LikeResult insertLike = pService.insertLike(request);
